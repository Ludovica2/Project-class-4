    ...
    return (
        <nav className="flex justify-between items-center h-[65px] pr-[20px] dark:bg-elements_dark">
            ...
            <div className="flex justify-center items-center gap-2">
                <div>
                    <motion.button onClick={toggleSwitchDark} className="mr-4"
                        whileTap={{ scale: 0.95 }}
                    >
                        {
                    ...
                    <button onClick={toggleMessage}>
                        <div className="flex justify-center items-center">
                            ...
                            {
                                isOpenMessage && (
                                    <motion.div ref={messageRef} className="top-12 right-7 flex flex-col p-4 w-48 bg-white absolute z-10 rounded shadow dark:bg-elements_dark dark:shadow-slate-400"
                                        initial={{ y: 100 }}
                ...
                <div>
                    <button onClick={toggleNotify}>
                        <div className="flex justify-center items-center">
                            ...
                            {
                                isOpenNotify && (
                                    <motion.div ref={notifyRef} className="top-12 right-6 flex flex-col p-4 w-48 bg-white absolute z-10 rounded shadow dark:bg-elements_dark dark:shadow-slate-400"
                                        initial={{ y: 100 }}
                                        animate={{ y: "calc(0vw + 10%)" }}
                                    >
                                        <div className="mb-4">
                ...
                <div>
                    <button onClick={toggleProfileMenu}>
                        <div className="flex justify-center items-center">
                            ...
                            {
                                isOpenMenu && (
                                    <motion.div ref={menuRef} className="top-12 right-5 flex flex-col p-4 w-48 bg-white absolute z-10 rounded shadow dark:bg-elements_dark dark:shadow-slate-400"
                                        initial={{ y: 100 }}
                                        animate={{ y: "calc(0vw + 10%)" }}
                                    >
                                        <div className="mb-4">

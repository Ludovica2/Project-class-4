...
const Chat = () => {
    ...
    const dummyData = {
        ...
        chats: [
            ...
            { id: 6, message: 'Send me the code, I will look into it', timestamp: '10:02 AM', type: 'sent' },
        ]
    };
    ...
    return (
        <div className='flex flex-col sm:flex-row w-full h-screen'>
            <div className='sm:w-1/4 w-full bg-primayColor text-white overflow-y-auto'>
                <div className='flex items-center bg-white dark:bg-elements_dark p-2 w-11/12 mx-auto mt-4 rounded-md mb-1'>
                    <FaSearch />
                ...
                {dummyData.contacts.map(contact => (
                    <div key={contact.id} className='flex items-center p-4 hover:bg-primayColor_Hover cursor-pointer'>
                        ...
                        <div className='ml-4 flex-1'>
                            ...
                            <p className='text-white text-xs truncate'>{contact.message}</p>
                        </div>
                    </div>
                ))}
            </div>

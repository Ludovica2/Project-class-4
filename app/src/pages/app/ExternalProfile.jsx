                                    ...
                                    <div className="flex flex-col w-full gap-2">
                                        ...
                                        <div className=" flex w-3/4 my-3 gap-3 max-md:w-full">
                                            ...
                                            <Link to={"/app/chat"} target="_blank" className="w-1/2">
                                                <button className="w-full px-4 py-2 end-2.5 bottom-2.5 font-medium border border-slate-300 rounded-lg text-[#767d89] hover:bg-slate-100 dark:text-slate-300 dark:bg-zinc-600 dark:hover:bg-zinc-700 dark:hover:border-none">

                    ...
                    <div className="flex justify-center">
                        <div className="flex flex-col w-w_450 2xl:w-w_500 mt-4 p-4 bg-white border border-gray-300 rounded-md dark:bg-elements_dark max-xs:w-80 max-xxs:border-none">
                            ...
                            <div className="mt-5 mb-4 text-center">
                                <p className="text-dark">Non hai ancora un Account? Prova il nostro <Link to={"/signup-business"} className="link">Found! Business</Link></p>
                            </div>
                            <div className="mt-6 mx-5">
                                <span className="block h-px mb-4 bg-gray-300"></span>
                                <p className="font-semibold mb-1 dark:text-slate-300">Non sei un'azienda? </p>
                                <p className="mb-2">
                                    <Link to={"/"} className="link">Accedi</Link>
                                </p>
                                <p className="font-semibold mb-1 dark:text-slate-300">Hai bisogno di aiuto? </p>
                                <p className="mb-2">

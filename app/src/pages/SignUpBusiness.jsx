                        ...
                        <div className="flex flex-col w-w_450 2xl:w-w_500 mt-4 p-4 bg-white border border-gray-300 rounded-md dark:bg-elements_dark max-xs:w-80 max-xxs:border-none">
                            ...
                            <form onSubmit={handleSignIn}>
                                <div className="flex flex-col">
                                    ...
                                    <input type="text" name="company_name" id="company_name" onInput={handleInput} value={form.company_name} placeholder={dictionary.subscription.PH_COMPANY} className="my-2 p-2 input_field" />
                                </div>
                                <div className="flex flex-col">
                                ...
                                <div className="my-4 p-3 border border-gray-200 rounded-md relative">
                                    <span className="absolute left-4 -top-[11px] px-1 bg-white text-sm text-gray-400 dark:bg-elements_dark">{dictionary.subscription.CONTACT}</span>
                                ...
                                <div>
                                    <button type="submit" className="w-full my-3 p-2 border bg-primaryColor text-white rounded-md  hover:bg-primaryColor_Hover hover:border hover:border-primaryColor_Border_Hover">{dictionary.btn.SUBSCRIBE}</button>
                                </div>
                            </form>
                            <div className="mt-5 mb-4 text-center">
                                <p className="text-dark">{dictionary.subscription.LOGIN} <Link to="/login-business" className="link">{dictionary.btn.LOGIN}</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
